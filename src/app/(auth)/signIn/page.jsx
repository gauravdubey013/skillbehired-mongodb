        ...
        <div className="w-[85%] md:w-[80%] lg:w-[65%] h-[90%] border-[1px] border-solid border-[#53c28b]/90 rounded-2xl shadow-lg flex flex-rol gap-0 p-1 ease-in-out duration-300">
          ...
          */}
          ...
          <form action="" onSubmit={handleSubmit} className="fontFam w-full sm:w-[50%] h-full flex flex-col justify-between gap-5 px-5 rounded-xl ease-in-out duration-300">
            ...
            <div className="w-full h-full flex flex-col gap-4 overflow-hidden">
              <div className="h-16">
                <input type="email" placeholder='Enter E-mail' className={`allFormInput h-[52px]  ${errors.email ? 'border-red-500 placeholder:text-red-500' : ''} `}
                  value={email}
                  onChange={(e) => setemail(e.target.value)} />
                {errors.email && <span className="text-red-500">{errors.email}</span>}
              </div>
              <div className="h-16">
                <input type="text" placeholder='Enter Password' className={`allFormInput h-[52px]  ${errors.password && 'border-red-500 placeholder:text-red-500'} `}
                  value={password}
