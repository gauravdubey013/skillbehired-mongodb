      ...
      <div className="overflow-hidden -translate-y-[66px] md:-translate-y-[101px] -mb-[100px]">
        ...
        <section ref={ref.current} className="relative">
          ...
          <div className="w-full h-[101vh] bg-transparent relative z-20 flex flex-col justify-center p-[20px] sm:px-[65px] md:px-[65px] lg:px-[200px] ease-in-out duration-300">
            ...
            <div className="animate-fade-in-down flex flex-col sm:flex-row gap-1 sm:gap-0 ease-in-out duration-300">
              <input
                type="text"
        ...
        >
          ...
          <div id="services" className="w-full h-auto p-[20px] sm:px-[30px] md:px-[45px] lg:px-[80px] z-20">
        ...
        <br/>
        {/* about-section */}
        <section id="about" className="w-full h-screen flex flex-col md:flex-row bdbg">
          <div className="w-full md:w-[60%] lg:w-1/2 h-full flex flex-col gap-2 p-[20px] sm:px-[30px] md:px-[45px] lg:px-[80px] z-20 ease-in-out duration-300">
            ...
            <div className="">
              <p>
                ...
                sequi totam animi deleniti reiciendis error veritatis delectus
                similique maxime cumque sapiente quasi, odit eaque earum ipsum
                illum nobis impedit minus non ipsa nihil quaerat. Fuga quasi
                asperiores nam accusamus officia quae laudantium vitae, laborum
                eius. Maiores assumenda architecto asperiores autem? Our Experts
                Are the Finest
                <br />
                <br />
                Lorem ipsum dolor sit amet consectetur adipisicing elit.
                Corporis quia laudantium quam ullam maiores? Laborum
                perspiciatis modi ducimus nemo natus laudantium nobis vero
                dolore commodi rerum cum recusandae voluptas corrupti deleniti
                debitis quidem maiores, culpa aspernatur? Nulla facilis totam
                repudiandae atque minima blanditiis, incidunt dignissimos natus
                eos fugit beatae laudantium officia, praesentium labore in,
                distinctio ex eligendi suscipit corrupti. Corporis deleniti
                natus eum eveniet quas !
              </p>
            </div>
          </div>
        ...
        {/* contact-section */}
        <section id="contact" className="relative z-10 h-[120vh] mt-5 md:h-screen bdbg">
          <Contact />
        </section>
      </div>
    </>
